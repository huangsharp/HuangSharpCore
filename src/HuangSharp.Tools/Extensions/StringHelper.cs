...
public class StringHelper
{
    ...
    {
        List<string> seedsString = _allChars;
        var randomString = "";
    ...
    {
        long newLong = BitConverter.ToInt64(guid.ToByteArray(), 0);
        string newValueString = Math.Abs(newLong).ToString();
        ...
        {
            byte byteValue = Convert.ToByte(newValueString[i]);
            var fixedIndex = 1;
